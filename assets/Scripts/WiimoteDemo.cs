...
public class WiimoteDemo : MonoBehaviour {
	...
	void Update () {
        ...
        Debug.Log("Accel: " + GetAccelVector() / 10);
        int ret;
        do
        {
            ...
            if (ret > 0 && wiimote.current_ext == ExtensionController.MOTIONPLUS) {
                ...
                Vector3 offset = new Vector3(wiimote.MotionPlus.PitchSpeed, RollInverter, (Mathf.Round(wiimote.MotionPlus.YawSpeed))) / 100;
                Vector3 offset2 = new Vector3(-wiimote.MotionPlus.PitchSpeed, -RollInverter, -(Mathf.Round(wiimote.MotionPlus.YawSpeed))) / 100;
                wmpOffset += offset;
                ...
                if(OldAccel != (GetAccelVector() / 100))
                {
                    UnModel.Rotate(offset);
                    UnModelWrist.Rotate(offset2);
                }
                //UnModel.Rotate(offset);
